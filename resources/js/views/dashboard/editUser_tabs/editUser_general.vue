                            ...
                            <div class="row">
                                ...
                                <div class="col-12 col-md-6">
                                    <div class="edit_user_avatar">
                                        <div v-if="this.user.avatar_url === ''">
                                            <div class="edit_user_initials">
                                                <div>{{initials}}</div>
                                            </div>
                                        </div>
                                        <img v-else :src="'/avatars/' + this.user.avatar_url" alt="avatar">
                                    </div>
                                </div>
                                <div class="col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <div class="edit_user_buttons">
                                        <button class="edit_user_btn_save" v-on:click="userSave">
                                            Сохранить
                                            <b-modal v-model="userUpdated" centered ok-only @ok="userOk">Пользователь успешно обновлен</b-modal>
                                        </button>
...
<script>
    export default {
        ...
        methods: {
            async edit() {
                await axios.get(`/api/dashboard/user/${this.id}/edit`)
            ...
            async userSave() {
                this.errors = [];
                await axios.put(`/api/dashboard/user/${this.user.id}`, this.user)
                    .catch(error => {
...
<style scoped>
    ...
    .edit_user_avatar, .edit_user_initials {
        margin-top: 12px;
    }
