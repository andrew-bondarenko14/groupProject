<template>
    <div class="settings_block-wrapper">
        <header>
            <h2>Настройки безопасности</h2>
            <ul class="tabs">
                <li class="active"><router-link :to="{name: 'security_settings'}">Вход в аккаунт</router-link></li>
                <li><router-link :to="{name: 'security_history'}">История</router-link></li>
            </ul>
        </header>
        <div>
